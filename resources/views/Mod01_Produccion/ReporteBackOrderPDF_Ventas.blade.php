            ...
            <thead class="thead-dark">
                <tr>
                    <td colspan="6" align="center" bgcolor="#fff">
                        ...
                        <b>Reporte de BackOrder Programado (Ventas)</b>
            ...
            <div class="row">                
                    <table border="1px" class="table table-striped">
                        <thead class="table table-striped table-bordered table-condensed">
                            <tr>
                                ...
                                <th align="center" bgcolor="#474747" style="color:white" ; scope="col">F.Pedido</th>
                                <th align="center" bgcolor="#474747" style="color:white" ;scope="col">O.C.</th>
                ...
                <footer>
                    <script type="text/php">
                        ...
                        $tittle = 'Siz_Reporte_BackOrderV.Pdf'; 
